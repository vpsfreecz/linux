...
struct perf_event {
	...
	bool				container_kprobe_userns_lifecycle;
...
extern struct perf_event *perf_file_event(const struct file *file);
...
static inline struct perf_event *perf_file_event(const struct file *file)
{
