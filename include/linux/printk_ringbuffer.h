...
enum desc_state {
	...
	desc_reusable	= 0x3,	/* free, unused by any writer */
};
 ...
 * sequence number of 0.) After the first reservation, all subsequent reservations
 * (recycling) simply involve incrementing the sequence number by the array
 * count.
 *
 *   Initial-state exception #1
