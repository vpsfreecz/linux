...
static inline void
mem_cgroup_proactive_swap_charge(struct mem_cgroup *memcg,
				 unsigned int nr_pages)
{
}

static inline void
mem_cgroup_proactive_swap_uncharge(struct mem_cgroup *memcg,
				   unsigned int nr_pages)
{
}

static inline unsigned long
mem_cgroup_proactive_swap_usage(struct mem_cgroup *memcg)
{
	return 0;
}
