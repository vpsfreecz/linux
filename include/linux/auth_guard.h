...
AUTH_GUARD_STUB_TRUE(auth_guard_task_begin_transition_wait_where,
	(struct task_struct *task, const char *where))
static inline bool
auth_guard_task_begin_exec_transition_where(struct task_struct *task,
					    const char *where)
{
	return true;
}
...
AUTH_GUARD_STUB_TRUE(auth_guard_nsproxy_check_where,
	(const struct nsproxy *nsproxy, const char *where))
static inline bool
auth_guard_nsproxy_check_wait_where(const struct nsproxy *nsproxy,
				    const char *where)
{
	return true;
}
...
#define auth_guard_task_begin_transition_try(_task) \
	auth_guard_task_begin_transition_try_where((_task), __func__)
#define auth_guard_task_begin_transition_wait(_task) \
	auth_guard_task_begin_transition_wait_where((_task), __func__)
#define auth_guard_task_begin_exec_transition(_task) \
...
#define auth_guard_task_check_in_transition(_task) \
	auth_guard_task_check_in_transition_where((_task), __func__)
...
#define auth_guard_nsproxy_check_status(_nsproxy) \
	auth_guard_nsproxy_check_status_where((_nsproxy), __func__)
#define auth_guard_nsproxy_check(_nsproxy) \
	auth_guard_nsproxy_check_where((_nsproxy), __func__)
#define auth_guard_nsproxy_check_wait(_nsproxy) \
	auth_guard_nsproxy_check_wait_where((_nsproxy), __func__)
