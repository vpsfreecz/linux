...
static u64 bpf_container_delegate_attach_mask(void)
{
	return BIT_ULL(BPF_CGROUP_INET_INGRESS) |
	       ...
	       BIT_ULL(BPF_CGROUP_INET_SOCK_RELEASE) |
	       BIT_ULL(BPF_CGROUP_INET4_POST_BIND) |
	       BIT_ULL(BPF_CGROUP_INET6_POST_BIND) |
	       BIT_ULL(BPF_CGROUP_DEVICE) |
	       BIT_ULL(BPF_CGROUP_INET4_BIND) |
	       BIT_ULL(BPF_CGROUP_INET6_BIND) |
	       BIT_ULL(BPF_CGROUP_INET4_CONNECT) |
	       BIT_ULL(BPF_CGROUP_INET6_CONNECT) |
	       BIT_ULL(BPF_CGROUP_UNIX_CONNECT) |
	       BIT_ULL(BPF_CGROUP_INET4_GETPEERNAME) |
	       BIT_ULL(BPF_CGROUP_INET6_GETPEERNAME) |
	       BIT_ULL(BPF_CGROUP_UNIX_GETPEERNAME) |
	       BIT_ULL(BPF_CGROUP_INET4_GETSOCKNAME) |
	       BIT_ULL(BPF_CGROUP_INET6_GETSOCKNAME) |
	       BIT_ULL(BPF_CGROUP_UNIX_GETSOCKNAME) |
	       BIT_ULL(BPF_CGROUP_UDP4_SENDMSG) |
	       BIT_ULL(BPF_CGROUP_UDP6_SENDMSG) |
	       BIT_ULL(BPF_CGROUP_UNIX_SENDMSG) |
	       BIT_ULL(BPF_CGROUP_UDP4_RECVMSG) |
	       BIT_ULL(BPF_CGROUP_UDP6_RECVMSG) |
	       BIT_ULL(BPF_CGROUP_UNIX_RECVMSG) |
	       BIT_ULL(BPF_CGROUP_SOCK_OPS) |
	       BIT_ULL(BPF_CGROUP_SYSCTL) |
	       BIT_ULL(BPF_CGROUP_GETSOCKOPT) |
	       BIT_ULL(BPF_CGROUP_SETSOCKOPT) |
	       BIT_ULL(BPF_LSM_CGROUP) |
	       BIT_ULL(BPF_LSM_MAC);
}
