...
static __always_inline u64 bpf_time_maybe_adjust_unprivileged(u64 time)
{
	/* Round the time down for tasks outside init_user_ns. */
	if (sysctl_unprivileged_bpf_time_adjust_nsec &&
