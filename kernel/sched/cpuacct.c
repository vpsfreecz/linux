...
{
	struct cpuacct *ca = css_ca(css);
	struct kernel_cpustat *cpustat = per_cpu_ptr(ca->cpustat, cpu);
	struct kernel_cpustat *cpustat_old = per_cpu_ptr(ca->cpustat_old, cpu);
	...
	*user_old = cpustat_old->cpustat[CPUTIME_USER];
	*system_old = cpustat_old->cpustat[CPUTIME_SYSTEM];
	*user = cpustat->cpustat[CPUTIME_USER];
	*system = cpustat->cpustat[CPUTIME_SYSTEM];
	cpustat_old->cpustat[CPUTIME_USER] = *user;
	cpustat_old->cpustat[CPUTIME_SYSTEM] = *system;
...
{
	struct cpuacct *ca = css_ca(css);
	struct kernel_cpustat *cpustat_fake = per_cpu_ptr(ca->cpustat_fake, cpu);
	...
	*user = cpustat_fake->cpustat[CPUTIME_USER];
	*system = cpustat_fake->cpustat[CPUTIME_SYSTEM];
				 ...
				 u64 user, u64 system)
{
	...
	cpustat_fake->cpustat[CPUTIME_USER] += user;
	cpustat_fake->cpustat[CPUTIME_SYSTEM] += system;
