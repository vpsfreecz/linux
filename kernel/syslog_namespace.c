						...
						struct syslog_namespace *old_ns)
{
	 ...
	 * user_ns if you share a user_ns with your parent user_ns
	if (user_ns == &init_user_ns ||
		user_ns->syslog_ns != user_ns->parent->syslog_ns)
...
static int syslogns_install(struct nsproxy *nsproxy, struct ns_common *new)
{
