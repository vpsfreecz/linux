...
check_eq tracing_unchanged_without_request \
	"$(get_field "$out" parent_tracing)" \
	"$(get_field "$out" child_tracing)"
check_ne syslog_changes_without_tracing_request \
...
check_ne nested_syslog_user_boundary \
	"$(get_field "$out" child_user)" \
	"$(get_field "$out" grandchild_user)"
check_ne nested_syslog_pid_boundary \
	"$(get_field "$out" child_pid)" \
	"$(get_field "$out" grandchild_pid)"
check_ne nested_syslog_boundary \
	"$(get_field "$out" child_syslog)" \
	"$(get_field "$out" grandchild_syslog)"
check_eq nested_syslog_keeps_tracing \
	"$(get_field "$out" child_tracing)" \
	"$(get_field "$out" grandchild_tracing)"
