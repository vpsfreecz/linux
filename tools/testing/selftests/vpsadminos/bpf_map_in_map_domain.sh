...
check_eq consumer_send_outer_errno 0 \
	"$(get_field "$out" consumer_send_outer_errno)"
check_eq consumer_send_inner_errno 0 \
	"$(get_field "$out" consumer_send_inner_errno)"
check_eq child_cross_domain_recv_errno 0 \
	"$(get_field "$out" child_cross_domain_recv_errno)"
check_eq child_cross_domain_errno 13 \
	"$(get_field "$out" child_cross_domain_errno)"
check_eq host_outer_recv_errno 0 "$(get_field "$out" host_outer_recv_errno)"
check_eq host_inner_recv_errno 0 "$(get_field "$out" host_inner_recv_errno)"
check_eq host_same_domain_errno 0 \
	"$(get_field "$out" host_same_domain_errno)"
check_eq host_cross_domain_errno 13 \
	"$(get_field "$out" host_cross_domain_errno)"
